...
exports.createFileAsset = async(walletID, fileId, fileName, ipfsPath, publicKey, sharedKey, ownerID, accessUserList) => {
    try {
        ...
        const result = await contract.submitTransaction('CreateFileAsset', fileId, fileName, ipfsPath, publicKey, sharedKey, ownerID, accessUserList, dt);
