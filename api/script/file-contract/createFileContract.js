...
exports.createFileAsset = async(walletID, fileId, fileName, mimeType, ipfsPath, sharedKey, ownerID, accessUserList) => {
    try {
        ...
        const result = await contract.submitTransaction('CreateFileAsset', fileId, fileName, mimeType, ipfsPath, sharedKey, ownerID, accessUserList, dt);
