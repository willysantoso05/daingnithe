...
exports.createFileAsset = async(walletID, fileId, fileName, mimeType, ipfsPath, publicKey, sharedKey, ownerID, accessUserList) => {
    try {
        ...
        const result = await contract.submitTransaction('CreateFileAsset', fileId, fileName, mimeType, ipfsPath, publicKey, sharedKey, ownerID, accessUserList, dt);
