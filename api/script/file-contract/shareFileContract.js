...
exports.createFileAsset = async(walletID, userID, fileId, sharedKey, accessUserList) => {
    try {
        ...
        const result = await contract.submitTransaction('UpdateFileAccessAsset', userID, fileId, sharedKey, accessUserList);
