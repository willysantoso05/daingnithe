...
exports.updateFileAsset = async(walletID, userID, fileId, fileName, ipfsPath, publicKey, sharedKey) => {
    try {
        ...
        const result = await contract.submitTransaction('UpdateFileAsset', userID, fileId, fileName, ipfsPath, publicKey, sharedKey, dt);
