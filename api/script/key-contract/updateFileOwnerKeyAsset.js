...
exports.updateFileOwnerKeyAsset = async(walletID, userID, keyId, newOwnerID) => {
    try {
        ...
        const result = await contract.submitTransaction('UpdateFileOwnerKeyAsset', userID, keyId, newOwnerID, dt);
