...
exports.createKeyAsset = async(walletID, keyId, ownerKeyId, fileId, ownerFileId, keyValue) => {
    try {
        ...
        const result = await contract.submitTransaction('CreateKeyAsset', keyId, ownerKeyId, fileId, ownerFileId, keyValue, dt);
